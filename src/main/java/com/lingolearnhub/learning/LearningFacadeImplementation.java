...
public class LearningFacadeImplementation implements LearningFacade {

    private final LearningStrategy strategy;
    private final UserProgressService progressService;

    public LearningFacadeImplementation(LearningStrategy strategy, UserProgressService progressService) {
